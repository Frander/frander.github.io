...
<html>
	<head>
		...
		<!-- METAS -->
	     <meta name="description" content="Sitio de Desarrollador Web Nicaragua" />
	     <meta name="keywords" content="Nicaragua Web Desarrollo Programacion" />
	     <meta name="author" content="Frander Mejía" />
	    <!-- /METAS -->
	...
	<body>
		...
		<section id="encabezado" class="centrar">
			<h1>Frander Mejía</h1>
			...
			<div id="social">
				<ul>
					<li>
					<a href="https://www.facebook.com/frander.mejia"><img src="img/face.png" width="35px" height="35px"></a></li>
					<li>
					<a href="https://twitter.com/FranderMejia"><img src="img/twiiter.png" width="35px" height="35px"></a></li>
					<li><a href="https://plus.google.com/u/0/108949702897425672781/posts"><img src="img/plus.png" width="35px" height="35px"></a></li>
				</ul>
			</div>
			
		</section>

		<section id="servicios" class="centrar">
			<h1>Servicios</h1>
		...
		<section id="portafolio">
			...
			<div id="portafoliojs" class="centrar">
		...
		<section id="contacto" class="centrar2">
			...
			<div>
				...
				<div class="col-sm-7">
					...
					<form id="frmcontacto" class="form-horizontal" method="POST" action="contacto.php">
						...
						<!-- Textarea -->
						<div class="form-group">
						  <label class="col-md-1 control-label" for="mensaje">Mensaje</label>
						  <div class="col-md-12">                     
						...
						<div class="form-group">
						  ...
						  <div class="col-md-12">
						    <button id="enviar" name="enviar" class="btn btn-info">Enviar Mensaje</button>
						  </div>
						</div>
